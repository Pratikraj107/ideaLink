  ...
  return (
    <div className="flex flex-col space-y-8 px-2 sm:px-0 pt-6 sm:pt-0">
      <div className="space-y-4">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl  tracking-tight leading-tight sm:leading-tight">
          ...
          <span className="block text-black sm:bg-gradient-to-r sm:from-[#85A67B] sm:to-[#FFCBA4] sm:bg-clip-text sm:text-transparent">What Matters.</span>
        </h1>
